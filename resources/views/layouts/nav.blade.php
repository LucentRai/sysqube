	...
	<div class="container px-4 px-lg-5">
		<a class="navbar-brand" href="/">
			<svg xmlns="http://www.w3.org/2000/svg" id="z_logo" viewBox="0 0 64.312 40.348">
				...
				<path data-name="Path 2" d="M234.607,71.992,221.365,58.75,211.051,69.082l3.265,3.249,7.049-7.067,7.085,7.067,2.908,2.908,3.356,3.372-3.356,3.356,3.249,3.265,6.621-6.621-6.621-6.619" transform="translate(-100.774 -17.947)" fill="#fdb811" fill-rule="evenodd"></path>
				<path data-name="Path 3" d="M256.958,73l-5.23,5.228,2.91,2.91,2.32-2.3,8.923,8.923-8.923,8.923-2.32-2.3-3.249-3.265-3.354-3.354L251.39,84.4l-2.908-2.926L242.2,87.759l6.282,6.281,3.247,3.249,5.23,5.228,14.757-14.757L256.958,73" transform="translate(-120.805 -27.111)" fill="#003a78" fill-rule="evenodd"></path>
				<path data-name="Path 4" d="M175.038,78.228,169.808,73,155.051,87.759l14.757,14.757,5.23-5.228-2.926-2.91-2.3,2.3-8.923-8.923,8.923-8.923,2.3,2.3,3.265,3.265,3.354,3.356-3.354,3.354,2.908,2.926,6.282-6.281-6.282-6.282-3.247-3.249" transform="translate(-64.761 -27.111)" fill="#003a78" fill-rule="evenodd"></path>
				</g>
				</g>
			</svg>
			<h3 class="d-inline-block">SysQube Blogs</h3>
		</a>
